    ...
    <body>
        ...
        <div id="breadcrumb" class="section">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="breadcrumb-header">Elige entre dos fechas para mostrar los listados</h3>
                    </div>
                </div>
                <!-- /row -->
            </div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="form group">
                        <form action="controlListaPedidoFecha" method="post">
                            <input type="date" name="fechaMinima" min="2010-01-01" max="2022-12-31" class="border border-danger" style="margin-right: 5%" required="true">
                            <input type="date" name="fechaMaxima" min="2010-01-01" max="2022-12-31" class="border border-danger" style="margin-right: 4%" required="true">
