<%-- 
    Document   : pedidosPorClientes
    Created on : 9 ene. 2022, 22:03:13
    Author     : alber
--%>
    ...
    <body>
        ...
        <div id="breadcrumb" class="section">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="breadcrumb-header">Selecciona un cliente de la lista para ver su lista de pedidos</h3>
                    </div>
                </div>
                <!-- /row -->
            </div>
        ...
        <%  ServletContext contexto = getServletContext();
            ...
            List<Usuario> listaClientes = BDD.BuscarClientes();
