<%-- 
    Document   : storePorCategoria
    Created on : 15 ene. 2022, 14:21:55
    Author     : alber
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <!-- /NAVIGATION -->
        <%
            List<Producto> listaPorCategoria = (List<Producto>) contexto.getAttribute("listaPorCategoria");
            String categor = listaPorCategoria.get(0).getCategoria();
        %>
        <!-- BREADCRUMB -->
                ...
                <div class="row">
                    ...
                    <div id="aside" class="col-md-3">
                        ...
                        <div class="aside">
                            ...
                            <div class="product-widget">
                                <div class="product-img">
                                    <img src="img/<%=p.getFoto()%>" alt="Imagen no disponible">
                                </div>
                                <div class="product-body">
                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <div class="row">
                            <div id="paginacion" class="text-center">
                                <%
                                    int cont = 0;
                                    for (Producto p : listaPorCategoria) {
                                        cont++;
                                %>
                                <!-- product -->
                                <div class="col-md-4 col-xs-6 ">
                                    <div class="product">
                                        <form action="AddCarrito" method="post">
                                            <div class="product-img">
                                                <img src="img/<%=p.getFoto()%>" width="100px" height="225px" alt="Imagen no disponible">
