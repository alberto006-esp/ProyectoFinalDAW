                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb-tree">
                            <li>Home</li>
                            <li>Categorias</li>
                            <li class="active">Resulstados</li>
                        </ul>
                    </div>
                </div>
                <!-- /row -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div id="aside" class="col-md-3">
                        ...
                        <!-- aside Widget -->
                        <% List<Producto> listaFiltroPrecio = (List<Producto>) contexto.getAttribute("listaFiltroPrecio");
                        %>
                        <div class="aside">
                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <div class="row">
                            <div id="paginacion" class="text-center">
                                <%
                                    int cont = 0;
                                    for (Producto p : listaFiltroPrecio) {
                                        cont++;
                                %>
                                <!-- product -->
